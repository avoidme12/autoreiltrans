...
export default function Home() {
  ...
  const advantages = [
    ...
    },
    {
      icon: "🔒",
      title: "Надежность",
      description: "Гарантия сохранности вашего груза"
    },
    {
      icon: "📊",
      title: "Отслеживание",
  ...
  return (
      <div className="min-h-screen bg-gray-900 text-white overflow-x-hidden">
        <Head>
          <title>TechnoTrans | Грузоперевозки нового поколения</title>
        ...
        <div className="fixed inset-0 z-0 overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gray-800"></div>
          <div
          ...
          <main className="container mx-auto px-4">
            ...
            <section className="min-h-screen flex flex-col justify-center relative overflow-hidden pt-20">
              <div className="relative z-10">
                ...
                <div className="mt-12">
                  <button className="px-8 py-3 bg-red-600 hover:bg-red-700 rounded-md font-medium mr-4 transition-all duration-300 hover:scale-105">
                    Рассчитать стоимость
                  </button>
                  <button className="px-8 py-3 border border-white/30 hover:border-red-500 rounded-md font-medium transition-all duration-300 hover:scale-105">
                    Отследить груз
                  </button>
                </div>
              </div>
              ...
              <div
                  ref={parallaxRef}
                  className="absolute -bottom-40 -right-40 w-96 h-96 bg-red-500/10 rounded-full filter blur-3xl opacity-70 z-0"
              />
            </section>
                ...
                <div className="flex flex-col md:flex-row items-center">
                  <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                    ...
                    <div className="flex">
                      ...
                      />
                      <button className="px-6 py-3 bg-red-600 hover:bg-red-700 rounded-r-md font-medium transition-all duration-300">
                        Найти
                      </button>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li><a href="#" className="text-white/60 hover:text-red-400 transition-colors">Вакансии</a></li>
                  </ul>
                </div>
                <div>
                  <h4 className="text-lg font-semibold mb-4 text-white">Контакты</h4>
                  <ul className="space-y-2">
                    <li className="text-white/60">+7 (123) 456-78-90</li>
                    <li className="text-white/60">info@technotrans.ru</li>
                    <li className="text-white/60">Москва, ул. Логистическая, 42</li>
                  </ul>
                </div>
              </div>
              <div className="border-t border-white/10 mt-8 pt-8 text-center text-white/50">
                <p>© {new Date().getFullYear()} TechnoTrans. Все права защищены.</p>
              </div>
            </div>
          </footer>
        </div>
